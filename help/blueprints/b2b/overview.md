...
| **[B2B受众和配置文件激活](b2b-audience-profile-activation.md)** | <ul><li>跨渠道和目标的统一B2B配置文件中创建和激活人员和帐户受众</li></ul> | <ul><li>Adobe Real-Time Customer Data Platform B2B edition</li><li>Adobe Journey Optimizer B2B edition</li><li>Adobe Customer Journey Analytics B2B edition</li></ul> |
| **[B2B帐户激活](b2b-account-activation.md)** | <ul><li>将帐户受众激活到广告目标和云存储，以实现定位、销售外联和分析</li></ul> | <ul><li>Adobe Real-Time Customer Data Platform B2B edition</li></ul> |
