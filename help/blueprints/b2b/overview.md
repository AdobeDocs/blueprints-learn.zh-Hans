...
| **[购买基于群组的营销和历程管理](./b2b-buying-group-journeys.md)** | <ul><li>设计并构建一个客户历程，该历程可以为购买组确定销售线索，从而提高营销活动在确认销售线索的销售机会方面的有效性</li></ul> | <ul><li>Adobe Journey Optimizer B2B edition</li><li>Adobe Real-time Customer Data Platform B2B 版</li><li>Adobe Marketo Engage</li></ul> |
