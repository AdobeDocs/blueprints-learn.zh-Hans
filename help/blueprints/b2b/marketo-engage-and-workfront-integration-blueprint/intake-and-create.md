...
>[!TIP]
>此Blueprint还作为B2B激活和营销下的[用例模式](/help/blueprints/use-case-patterns/b2b/campaign-intake-and-creation.md)提供。
...
使用Workfront和Marketo Engage，系统到系统连接允许[Workfront请求表单](https://experienceleague.adobe.com/docs/workfront/using/administration-and-setup/customize/custom-forms/create-or-edit-a-custom-form.html?lang=zh-Hans){target="_blank"}中的详细信息创建Marketo Engage程序，然后填写关键变量，如：主题行、电子邮件副本、图像、日期、时间、事件信息等。
...
·电子邮件副本<br />
·Call to action<br />
·图像 — 可直接引用AEM Assets URL以在Marketo中使用<br />
·受众资格标准</td>
  </tr>
  <tr>
   <td>网络研讨会/事件</td>
...
·活动城市<br />
·事件描述<br />
·网络研讨会录像页 — PageURL OnDemand<br />
·扬声器名称<br />
·扬声器标题<br />
·扬声器图像<br />
·需要电子邮件（邀请、确认、提醒、跟进）<br />
·电子邮件标题图像<br />
·受众资格标准</td>
  </tr>
  <tr>
...
要了解有关创建您自己的卓越中心的更多信息，请查看[Marketo社区](https://nation.marketo.com/t5/product-blogs/marketo-master-class-center-of-excellence-with-chelsea-kiko/ba-p/243221){target="_blank"}以了解最佳实践。
