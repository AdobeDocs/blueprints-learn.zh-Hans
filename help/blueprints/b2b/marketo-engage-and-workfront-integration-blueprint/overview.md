...
借助 Workfront Fusion，营销运营团队可以在很大程度上消除将营销摘要转换为营销活动时涉及的手动和容易出错的步骤。 Workfront Fusion 在 Workfront 和 Marketo Engage 之间提供了一个开箱即用的集成层，允许灵活、高效地在系统之间开发工作流。 有关如何设置集成以及可以执行哪些操作来自动化工作流[此处](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=zh-Hans){target="_blank"}的详细信息。
...
* 将来自 Marketo Engage 的营销活动结果共享到 Workfront，以实现对营销活动指标的访问民主化
...
<table> 
  ...
  <tr> 
   ...
   （例如，为公司内专门销售服务和/或产品的业务部门创建Portfolio。）</td>
  </tr>
  <tr>
   <td>计划</td>
   <td>您可以使用 Workfront 计划来组织项目。 通过组织项目，您可以比较类似的项目并确定资源的最佳使用位置。<br /><br />
   （例如，具有高级别目标的营销战略，如提高认识，推动对新产品上市的需求。）</td>
  </tr>
  <tr>
   <td>项目</td>
   <td>Workfront项目是完成特定目标、交付项、产品等需要完成的工作项的集合。<br /><br />
   (例如，营销策略，如电子邮件推送、培养活动、网络研讨会或面对面活动。 单个项目也可能更加复杂，因为它包含多种策略，如电子邮件、展示广告、登录页面和可下载的白皮书，所有这些策略都旨在推动相同的结果。)</td>
  </tr>
  <tr>
   <td>任务</td>
   <td>Workfront 任务是可能属于项目或方案一部分的计划工作项。 任务被分派给要完成的用户或团队。<br /><br />
   （例如，构建受众区段或创建电子邮件草稿的任务可能是与开发Marketo Engage电子邮件项目的任务。）</td>
  </tr>
  <tr>
   <td>问题</td>
  ...
  <tr>
   <td>文档</td>
   <td>文档可以是传统文档，如 Word文档或演示文稿， 也可以是图像文件。 Workfront允许通过文档和图像上的注释和批注进行资源校对，以实现团队之间的协作。<br /><br />
   （例如，需要审核的电子邮件标头图像。）</td>
  </tr>
  <tr>
   <td>更新</td>
   <td>包含评论和审核日志，用于跟踪工作并促进Workfront中的协作。<br /><br />
   （例如，新映像版本的审核日志。）</td>
  </tr>
  </tbody>
</table>
...
标准化营销活动和 URL 的命名约定是在 Marketo Engage 中准确管理计划的关键基础，有助于在整个营销活动开发生命周期中推动更一致的流程。 如果您正在寻找工具来帮助解决此问题，我们建议您从[Adobe Success Services](https://main--marketo-campaign-tools--dr-adobe.hlx.live/){target="_blank"}中签出一些免费的开源工具，这些工具允许您创建一致的方法来创建和管理Marketo Engage营销活动及其关联的URL。

### 资源 {#resources}

* [适用于Marketo Engage的Workfront Fusion](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=zh-Hans){target="_blank"}

* [适用于Workfront的Workfront Fusion](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/workfront-modules.html?lang=zh-Hans){target="_blank"}
