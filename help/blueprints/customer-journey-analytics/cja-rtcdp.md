---
title: 带有Real-time Customer Data Platform Blueprint的Customer Journey Analytics
...
# 带有Real-time Customer Data Platform Blueprint的Customer Journey Analytics
...
![架构图](assets/CJA.png){zoomable="yes"}

## Customer Journey Analytics 护栏图 Blueprint

* 有关详细的护栏和端到端延迟，请参阅[部署护栏文档](../experience-platform/guardrails.md)