...
[!DNL Experience Platform]允许与第三方SQL客户端、接口和Business Intelligence (BI)工具的连接使用[!DNL PostgreSQL]协议直接连接到、访问和查询[!DNL Experience Platform]中的数据。
