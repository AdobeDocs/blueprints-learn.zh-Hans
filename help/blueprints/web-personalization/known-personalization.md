...
1. 实施安装了正确扩展（Adobe Journey Optimizer 或 Target - Decisioning）的 [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=zh-Hans) 或 [Experience Platform Mobile SDK](https://aep-sdks.gitbook.io/docs/)。Experience PlatformWeb/Mobile SDK或Edge API是实时边缘分段所必需的，但将流受众和批量受众从Real-time Customer Data Platform共享到Target时则不需要。
...
* [Adobe Target Connection for Real-time Customer Data Platform](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection.html?lang=zh-Hans)
