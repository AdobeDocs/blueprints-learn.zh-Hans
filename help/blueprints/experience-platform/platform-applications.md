...
<img src="assets/aep+apps_vertical.svg" alt="Experience Platform 和应用程序" style="border:1px solid #4a4a4a; width:90%; margin-bottom: 15px;" class="modal-image" />

## Adobe Experience Platform 和应用程序详细架构图

<img src="assets/aep-app-architecture.svg" alt="Experience Platform 和应用程序" style="border:1px solid #4a4a4a; width:90%; margin-bottom: 15px;" class="modal-image" />
