---
title: 数字体验Blueprint — 行业成功案例
description: 了解成功案例展示各个行业如何使用由Adobe Experience Platform提供支持的Experience Cloud应用程序来实现业务价值。
...
了解客户如何通过数字体验Blueprint创造出色的体验并取得成功。 凭借这些经过验证的可重复实施，您能够明晰策略，快速解决既定的业务问题。
