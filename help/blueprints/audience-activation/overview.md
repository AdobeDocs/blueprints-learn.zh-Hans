...
| **[激活到文件和企业流传输目的地](enterprise-destinations.md)** | <ul><li>跨企业系统和应用程序激活和访问实时客户档案，以提供丰富的情境式客户体验。 </li></ul><ul><li>利用来自实时客户档案的分析和事件来触发销售或支持体验。</li></ul> | <ul><li>Adobe Experience Platform</li><li>[!UICONTROL 实时客户数据平台]</li><li>Experience Platform Activation</li><li>Adobe Audience Manager（可选）</li></ul> |
