...
# 具有Adobe [!DNL Real-Time CDP] v8集成模式的[!DNL Campaign]
...
<img src="images/rtcdp-campaign-v8-architecture.svg" alt="批次消息和 Adobe Experience Platform 集成模式的参考架构" style="width:100%; border:1px solid #4a4a4a" class="modal-image" />
