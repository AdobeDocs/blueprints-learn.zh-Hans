...
Journey Optimizer用于在适当的时间跨所有接触点为客户提供最佳选件和体验。 决策管理通过集中的营销选件库和决策引擎(该引擎将规则和约束应用于Adobe Experience Platform创建的丰富实时用户档案，以帮助您在适当的时间向客户发送正确的选件)，从而轻松实现个性化。
...
要了解有关边缘决策管理的更多信息，请参阅[边缘决策管理](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer/offer-decisioning/decision-management-edge.html) Blueprint。
...
<img src="../assets/offers_hub.svg" alt="边缘蓝图上的参考体系结构决策管理" style="width:100%; border:1px solid #4a4a4a" />
...
* 对于基于服务器API的决策管理实施，利用 [决策API](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/api-reference/offer-delivery/decisioning-vs-edge-apis.html?lang=zh-Hans).
...
* 对于基于Edge的实时体验，请按照 [Edge Blueprint上的决策管理](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer/offer-decisioning/decision-management-edge.html).
<br>
