...
| 场景 | 描述 | 功能 |
| :-- | :--- | :--- |
| [Real-Time CDP 与 Adobe Campaign](rtcdp-and-campaign.md) | 显示如何将 Adobe Experience Platform 的 Real-Time CDP 及其集中化分段工具与 Adobe Campaign 结合使用来提供个性化对话 | <ul><li>使用云存储文件交换和Adobe Campaign摄取工作流，将用户档案和受众从Real-Time CDP共享到Adobe Campaign </li><li>将客户对话中的传送和交互数据轻松共享回 Adobe Campaign 的 Real-Time CDP，以增强实时客户档案并提供有关消息传递营销活动的跨渠道报告</li></ul> |
