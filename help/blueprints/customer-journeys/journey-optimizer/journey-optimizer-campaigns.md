...
>[!TIP]
>此Blueprint还作为[用例模式](/help/blueprints/use-case-patterns/campaign-management-orchestration/batch-outbound-message-activation.md)在Campaign Management &amp; Orchestration下提供。
