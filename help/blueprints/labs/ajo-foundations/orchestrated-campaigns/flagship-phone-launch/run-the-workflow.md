...
2. 如果尚未停止工作流，请单击右上角的&#x200B;**停止**&#x200B;按钮。

   工作流右上角的![停止按钮](assets/run-the-workflow-click-stop-button.png)

   >[!NOTE]
   >
   >或者，尝试单击“重新启动”按钮，但您可能会看到错误，因为您在创建工作流后添加了活动，并且工作流缓存不再有效。
...
5. 您看到&#x200B;**33条记录**，并且定向维度与客户ID（个人资料的联接键）匹配
...
- 加入Real-time Customer Profile要求您具有客户ID，由于这4条记录中没有任何一个，因此不可能立即查找配置文件或创建新配置文件
...
>[!SUCCESS]
>
>恭喜！ 现在，您已获得正式认证，可负责任地启动您自己的编排促销活动并向世界各地广播消息。 现在，您可以放心地开展营销活动！
...
1. 保存受众活动会在受众门户中创建受众外壳，并且符合条件的配置文件会开始摄取
