...
<img src="assets/web_sdk_flow.png" alt="使用 Experience Platform Web 和 Mobile SDK 实施的参考架构" style="width:90%; border:1px solid #4a4a4a" />

序列图

<img src="assets/web_sdk_sequence.png" alt="线上/线下 Web 个性化 Blueprint 的参考架构" style="width:90%; border:1px solid #4a4a4a" />
