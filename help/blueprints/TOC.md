...
+ B2B 激活与营销 {#b2b-activation}
   ...
   + Marketo Engage 和 Workfront 集成 Blueprint{#marketo-engage-and-workfront-integration-blueprint}
      ...
      + [审查和批准](/help/blueprints/b2b/marketo-engage-and-workfront-integration-blueprint/review-and-approve-blueprint.md)
...
+ 客户历程 {#customer-journeys}
   ...
   + Campaign v7 {#campaign-v7}
      ...
      + [Real-Time CDP 与 Adobe Campaignv7](/help/blueprints/customer-journeys/rtcdp-and-campaign.md)
