...
+ AEP和应用程序的关键业务目标示例{#business-objectives}
...
+ 用例模式{#use-case-patterns}
   ...
   + 营销活动管理和编排{#campaign-orchestration-patterns}
      ...
      + [购买基于群组的营销和历程管理](/help/blueprints/use-case-patterns/campaign-management-orchestration/buying-group-based-marketing.md)
...
+ 行业用例示例{#industry-use-cases}
   + [概述](/help/blueprints/industry-use-cases/overview.md)
