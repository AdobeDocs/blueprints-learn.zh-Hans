---
title: Adobe Experience Platform Web SDK和[!DNL Edge Network]
description: 此架构图显示了通过Experience Platform Web和Mobile SDK以及[!DNL Edge Network]进行的引入
...
![使用Experience Platform Web和移动SDK实现的参考体系结构](assets/sdk_data_flow_diagram.png){width="1000" zoomable="yes"}

Experience Edge、Experience Platform 服务和应用程序的序列图

![在线/离线Web Personalization方案的参考体系结构](assets/sdk_sequence_diagram.png){width="1000" zoomable="yes"}
