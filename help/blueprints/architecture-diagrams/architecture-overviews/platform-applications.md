---
title: Adobe Experience Platform与应用程序
...
ht-degree: 19%
---
# Adobe Experience Platform与应用程序
...
![Experience Platform和应用程序](assets/aep_apps_overview.png){width="1000" zoomable="yes"}

## 详细的架构图

![Experience Platform和应用程序](assets/aep_apps_detailed.png){width="1000" zoomable="yes"}