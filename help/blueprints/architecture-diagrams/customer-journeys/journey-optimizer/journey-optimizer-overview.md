...
此概述概述了该应用程序的技术功能，并深入分析了构成[!DNL Journey Optimizer]的各种体系结构组件。
...
- **放弃恢复：**&#x200B;当用户通过电子邮件、推送或应用程序内放弃购物车、表单或sessionTuni¬a€”时触发个性化消息。
...
![Adobe Journey Optimizer的参考体系结构](images/ajo-architecture.png){width="1000" zoomable="yes"}
