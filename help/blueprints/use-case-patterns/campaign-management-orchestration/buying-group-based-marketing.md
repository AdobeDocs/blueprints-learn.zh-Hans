...
| 报告和分析 | 已包含 | [!DNL AJO B2B Edition]内的B2B分析功能板提供购买团体参与度、帐户历程绩效和管道量度。[!DNL CJA B2B Edition] 通过帐户级别的工作区分析、购买组分析和机会关联扩展分析。 | [CJA概述](https://experienceleague.adobe.com/zh-hans/docs/analytics-platform/using/cja-overview/cja-overview) |
