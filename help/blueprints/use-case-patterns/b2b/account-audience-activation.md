...
**应用程序功能：** [!DNL RT-CDP] B2B：帐户配置文件统一，[!DNL RT-CDP] B2B： B2B标识解析

**您将配置的内容：**&#x200B;此阶段通过合并CRM、营销自动化和第三方源中的数据来建立统一的帐户配置文件。 B2B身份解析映射人员与帐户的关系，以便可以聚合人员级别的参与数据（电子邮件打开、Web访问、内容下载）并在帐户级别的受众评估中使用。 此阶段的基础功能F2、F3和F4必须已经到位。
...
**应用程序功能：** [!DNL RT-CDP] B2B：帐户受众评估，[!DNL RT-CDP]：受众评估
...
**应用程序功能：** [!DNL RT-CDP] B2B：帐户目标配置，[!DNL RT-CDP] B2B： [!DNL Marketo Engage]集成，[!DNL RT-CDP]：目标配置
...
**应用程序功能：** [!DNL RT-CDP] B2B：帐户Audience Activation，[!DNL RT-CDP]： Audience Activation
...
**应用程序功能：** [!DNL RT-CDP] B2B： B2B数据管理，[!DNL RT-CDP]：同意和治理实施
