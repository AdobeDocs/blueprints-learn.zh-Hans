...
| 报告和分析 | 已包含 | 选件性能报告是执行计划（第7阶段）的一部分。 CJA analysis支持跨渠道选件有效性衡量、收入影响归因和优化机会识别。 | [CJA概述](https://experienceleague.adobe.com/zh-hans/docs/analytics-platform/using/cja-overview/cja-overview)，[Analysis Workspace概述](https://experienceleague.adobe.com/zh-hans/docs/analytics-platform/using/cja-workspace/home) |
...
**应用程序功能：** AEP：数据建模和准备，AEP：身份和配置文件配置
