...
**应用程序功能：** AEP：数据建模和准备(F2)，AEP：数据源和收集(F3)
...
**应用程序功能：** RT-CDP：受众评估、AJO：营销活动执行或Journey Orchestration
