...
| 报告和分析 | 已包含 | 推荐绩效报告是执行计划步骤4的一部分。 [!DNL Customer Journey Analytics]跨表面和区段的推荐有效性、收入影响和项目级绩效分析提供了优化见解。 | [CJA概述](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-overview)，[Analysis Workspace概述](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/home) |
